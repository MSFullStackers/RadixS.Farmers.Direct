...
namespace RadixS.Farmers.Direct.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DirectDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DirectEfCoreEntityExtensionMappings to extend the IdentityUser entity
